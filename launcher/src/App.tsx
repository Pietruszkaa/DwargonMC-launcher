    ...
    <main className="setup-shell">
      ...
      <section className="setup-panel" aria-label="Pierwsza konfiguracja">
        ...
        {state.setup.reason === 'crowded-folder' ? (
          <p>
            Launcher utworzy folder <strong>Dwargon Launcher</strong> i bedzie trzymal w nim Minecrafta, ustawienia,
            logi oraz pliki serwerow. Dzieki temu folder, z ktorego uruchomiono plik `.exe`, zostanie czysty.
          </p>
        ) : (
          <p>
            Launcher przygotuje folder danych z Minecraftem, ustawieniami, logami i plikami serwerow. Mozesz uzyc
            proponowanej lokalizacji albo wskazac wlasny folder.
          </p>
        )}
        ...
        <p className="setup-note">
          Plik `.exe` mozesz pozniej przeniesc recznie do wybranego folderu, jesli chcesz miec launcher i dane w jednym
        ...
        <footer className="setup-actions">
          ...
          <button className="play-button compact" type="button" onClick={finish} disabled={busy}>
            {busy ? 'Zapisywanie...' : 'Uzyj proponowanego folderu'}
          </button>
        </footer>
      </section>
    </main>
